...
VALUES (1000, 'usuario111', '$2a$10$52MmrjU1dvIb06yEnYjtFuepbXUpublwbgFysW/EEBnow5gjkaUU2', 'usuario1@test.com');
-- Asignar Rol (Asumo que el rol se llama 'ROLE_USER' o 'USER')
...
(1000, 'Transportes Rápidos S.L.', 'B12345678', '910000001', 'contacto@rapidos.com', 1000,
 'Calle Industria', '10', '28001', 'Madrid', 'Madrid', 'España', 'ES1234567890123456789012'),

(2000, 'Logística Global S.A.', 'A98765432', '930000001', 'info@global.com', 1000,
 'Avenida del Puerto', '55', '08001', 'Barcelona', 'Barcelona', 'España', 'ES9876543210987654321098');
...
-- ============================================================
-- 4. SERVICIOS EMPRESA 1000 (15 Total: 10 facturados, 5 sin facturar)
-- ============================================================

-- 10 Servicios FACTURADOS (vinculados a Factura 500)
INSERT INTO servicios (
    empresa_id, factura_id, tipo_servicio, fecha_servicio, origen_ciudad, destino_ciudad,
    km, precio_km, importe_servicio, conductor, matricula_vehiculo,
    origen_calle, origen_numero, origen_cp, origen_provincia, origen_pais,
    destino_calle, destino_numero, destino_cp, destino_provincia, destino_pais
)
SELECT
    1000, 500, 'Transporte Mercancía', CURRENT_DATE - (i || ' days')::INTERVAL, 'Madrid', 'Valencia',
    100, 1.00, 100.00, 'Conductor A', '1234-BBB',
    'Calle O', '1', '28000', 'Madrid', 'España',
    'Calle D', '2', '46000', 'Valencia', 'España'
...
SELECT
    1000, NULL, 'Transporte Urgente', CURRENT_DATE + (i || ' days')::INTERVAL, 'Madrid', 'Sevilla',
    200, 1.50, 300.00, 'Conductor B', '5678-CCC',
    'Calle O', '1', '28000', 'Madrid', 'España',
    'Calle D', '2', '41000', 'Sevilla', 'España'
FROM generate_series(1, 5) AS i;


-- ============================================================
-- 5. SERVICIOS EMPRESA 2000 (15 Total: 10 facturados, 5 sin facturar)
-- ============================================================
...
SELECT
    2000, 501, 'Mudanza', CURRENT_DATE - (i || ' days')::INTERVAL, 'Barcelona', 'Zaragoza',
    150, 1.00, 150.00, 'Conductor C', '9012-DDD',
    'Calle O', '1', '08000', 'Barcelona', 'España',
    'Calle D', '2', '50000', 'Zaragoza', 'España'
FROM generate_series(1, 10) AS i;
...
SELECT
    2000, NULL, 'Logística Interna', CURRENT_DATE + (i || ' days')::INTERVAL, 'Barcelona', 'Girona',
    50, 2.00, 100.00, 'Conductor D', '3456-FFF',
    'Calle O', '1', '08000', 'Barcelona', 'España',
    'Calle D', '2', '17000', 'Girona', 'España'
FROM generate_series(1, 5) AS i;